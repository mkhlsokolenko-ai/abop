...
# Параллелизм LLM-вызовов навыков = 2 (ЗАМЕР 2026-09-18: единая карта RouteAI троттлит при 5 →
# прогон стал в 2.7× МЕДЛЕННЕЕ, 110с→299с. Гипотеза «больше параллелизма быстрее» опровергнута.
# Реальный выигрыш дал дайджест данных, не параллелизм. Backoff-ретрай оставлен для устойчивости.
# Поднимать концы имеет смысл ТОЛЬКО с несколькими картами/своим vLLM.
